...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<!-- First Photo Grid-->
			...
			<form name="gotohome" action="selcar" method="post" OnSubmit="return fncSubmit();" style="height: 70%;width: 40%; margin: 150px;">
			<div class="panel panel-primary" style="margin-top: 15%">
				...
				</label> <select name="carYear" id="registration_year" class="form-control"
					class="custom-select" >
			...
			<option value="2017">2017</option>
					...
					<option value="">กรุณาเลือก</option>
					<optgroup label="รถยนต์">
						 <option value="ACCORD (Minor Change) 2.0 E">ACCORD (Minor Change) 2.0 E</option>
						<option value="ACCORD (Minor Change) 2.0 EL">ACCORD (Minor Change) 2.0 EL</option>
						<option value="ACCORD (Minor Change) 2.0 EL">ACCORD (Minor Change) 2.0 EL</option>
						<option value="ACCORD HYBRID 2.0 TECH">ACCORD HYBRID 2.0 TECH</option>
						<option value="BRIO 1.2 S A/T (MRHDD1830)">BRIO 1.2 S A/T (MRHDD1830)</option>
					</optgroup>
				</select>
					</div>
...
function fncSubmit(){
	if(document.form1.carYear.value == "")
	{
		alert('Please input carYear');
		document.form1.carYear.focus();
		return false;
	}	
	if(document.form1.carMake.value == "")
	{
		alert('Please input carMake');
		document.form1.carMake.focus();
		return false;
	}	
}
