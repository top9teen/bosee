...
-- Dumping structure for table projectdb2.amphur
...
-- Dumping data for table projectdb2.amphur: 993 rows
...
-- Dumping data for table projectdb2.brand: ~313 rows (approximately)
...
-- Dumping data for table projectdb2.car: ~40 rows (approximately)
...
-- Dumping structure for table projectdb2.district
...
-- Dumping data for table projectdb2.district: 8,860 rows
...
-- Dumping structure for table projectdb2.geography
...
-- Dumping data for table projectdb2.geography: 6 rows
...
-- Dumping data for table projectdb2.kasikorn_price: ~312 rows (approximately)
...
-- Dumping data for table projectdb2.krungsri_price: ~312 rows (approximately)
...
-- Dumping data for table projectdb2.memberrole: ~4 rows (approximately)
...
-- Dumping structure for table projectdb2.province
...
-- Dumping data for table projectdb2.province: 77 rows
...
CREATE TABLE IF NOT EXISTS `registerall` (
  ...
  `reg_amphur` varchar(255) DEFAULT NULL,
  `reg_district` varchar(255) DEFAULT NULL,
  `reg_moban` varchar(255) DEFAULT NULL,
  `reg_lastname` varchar(255) DEFAULT NULL,
  `reg_age` int(11) DEFAULT NULL,
  `reg_province` varchar(255) DEFAULT NULL,
  `reg_telephone` varchar(50) DEFAULT NULL,
  `reg_idcard` varchar(50) DEFAULT NULL,
  ...
  `reg_roleuser` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`reg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='ใบสมัครสินเชื่อรถที่รอการ อนุมัติ';

-- Dumping data for table projectdb2.registerall: ~6 rows (approximately)
/*!40000 ALTER TABLE `registerall` DISABLE KEYS */;
INSERT INTO `registerall` (`reg_id`, `reg_bankname`, `reg_firstname`, `reg_amphur`, `reg_district`, `reg_moban`, `reg_lastname`, `reg_age`, `reg_province`, `reg_telephone`, `reg_idcard`, `reg_email`, `reg_carmodel`, `reg_carmake`, `reg_totalincome`, `reg_salary`, `reg_lesslimit`, `reg_lessday`, `reg_imgfront`, `reg_imgback`, `reg_imgleft`, `reg_imgright`, `reg_date`, `reg_roleuser`) VALUES
	(22, 'kasikorn', 'test1', NULL, NULL, NULL, 'test2', 50, 'นครราชสีมา   ', '12121212', '122121', 'topcupdata29902@gmail.com', 'CAPTIVA 2.4 LSX', 'CHEVROLET', '2016', '2222', '2000', '24', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1'),
	(23, 'krungsri', 'test1', NULL, NULL, NULL, 'test2', 44, NULL, '444', '4444', 'ดกกหดกหด', '220 I COUPE SPORT (F22) Tourer', 'BMW', '2016', '2000', '12345', '12', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1'),
	(24, 'scbeasy', 'test1', NULL, NULL, NULL, 'test2', 44, NULL, '45455', '45445', 'topcupdata29902@gmail.com', 'FIESTA 1.0 ECOBOOT A/T 4DR MNBSXXARJ8', 'FORD', '2016', '500', '60000', '12', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1'),
	(25, 'krungsri', 'test1', 'บางบัวทอง   ', 'บางรักใหญ่   ', NULL, 'test2', 22, 'นนทบุรี   ', '2121122', '1212212', '454554', '118 I Sport', 'BMW', '2016', '21122', '5000', '12', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1'),
	(26, 'krungsri', 'test1', NULL, NULL, '545455', 'test2', 50, NULL, '545455', '5454545', 'เดเกดเกดเะดกเดกเ', 'FIESTA 1.5LTITANIUM 4DR/5DR A/T', 'FORD', '2015', '20', '5000', '12', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1'),
	(27, 'kasikorn', 'test1', NULL, NULL, '4444', 'test2', 44, NULL, '4444', '44444', '554646', 'test1.3', 'test1.1', '2018', '555', '20', '12', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', 'assets/img/imgreg/getstudentimageftp.jpg', '2018-06-08', '1');
...
-- Dumping data for table projectdb2.regname: ~3 rows (approximately)
...
INSERT INTO `regname` (`na_id`, `na_bankname`, `na_firstname`, `na_lastname`, `na_age`, `na_province`, `na_telephone`, `na_idcard`, `na_email`, `na_carmodel`, `na_carmake`, `na_totalincome`, `na_salary`, `na_lesslimit`, `na_lessday`, `na_imgfront`, `na_imgback`, `na_imgleft`, `na_imgright`, `na_date`, `na_idrole`) VALUES
	...
	(24, 'scbeasy', 'แกดกดหด', 'กฟกฟก', 22, 'ชัยนาท', 555555555, 555555555, 'กกหฟฟกฟก', 'CITY 1.5 S M/T (MRHGM6520)', 'HONDA', '2016', '55555', '500000', '36', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', 'assets/img/imgreg/java.jpg', '2018-06-01', 13);
/*!40000 ALTER TABLE `regname` ENABLE KEYS */;

-- Dumping structure for table projectdb2.roleuserall
CREATE TABLE IF NOT EXISTS `roleuserall` (
  `ro_category` varchar(50) DEFAULT NULL,
  `ro_role` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table projectdb2.roleuserall: ~5 rows (approximately)
/*!40000 ALTER TABLE `roleuserall` DISABLE KEYS */;
INSERT INTO `roleuserall` (`ro_category`, `ro_role`) VALUES
	('Admin', 1),
	('manager', 2),
	('inspector', 3),
	('approve', 4),
	('user', 5);
/*!40000 ALTER TABLE `roleuserall` ENABLE KEYS */;
...
-- Dumping data for table projectdb2.scbeasy_price: ~312 rows (approximately)
...
-- Dumping data for table projectdb2.thanachart_price: ~312 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `userall` (
  ...
  PRIMARY KEY (`us_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='รหัสเข้าทั้งหมด';

-- Dumping data for table projectdb2.userall: ~8 rows (approximately)
...
INSERT INTO `userall` (`us_id`, `us_fname`, `us_lname`, `us_address`, `us_role`, `us_createdate`, `us_username`, `us_password`, `us_img`) VALUES
	...
	(6, 'top', 'tan', 'toptan', '5', '2018-06-02', 'toptan', '1234', 'assets/img/imgpro/scbesy.jpg'),
	(7, 'test1', 'test2', 'NO ADDRESS', '5', '2018-06-02', 'tes3', '1234', 'assets/img/imgpro/noname.png'),
	(8, 'test4', 'test4', 'NO ADDRESS', '5', '2018-06-06', 'test4', '1234', 'assets/img/imgpro/noname.png'),
	(9, 'test5', 'test5', 'NO ADDRESS', '5', '2018-06-06', 'test5', '1234', 'assets/img/imgpro/noname.png');
...
-- Dumping data for table projectdb2.year: ~4 rows (approximately)
